...
bool edgevision_msgs__msg__tracked_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("edgevision_msgs.msg._tracked_detection.TrackedDetection", full_classname_dest, 55) == 0);
  }
  edgevision_msgs__msg__TrackedDetection * ros_message = _ros_message;
  {  // track_id
...
{
  /* NOTE(esteve): Call constructor of TrackedDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("edgevision_msgs.msg._tracked_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedDetection");
