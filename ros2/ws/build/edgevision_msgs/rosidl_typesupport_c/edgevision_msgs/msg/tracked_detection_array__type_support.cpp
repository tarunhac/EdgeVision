...
static const _TrackedDetectionArray_type_support_symbol_names_t _TrackedDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, edgevision_msgs, msg, TrackedDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, edgevision_msgs, msg, TrackedDetectionArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, edgevision_msgs, msg, TrackedDetectionArray)() {
  return &::edgevision_msgs::msg::rosidl_typesupport_c::TrackedDetectionArray_message_type_support_handle;
}
